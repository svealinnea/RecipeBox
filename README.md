...
4) Open your computer's terminal/console, and navigate to folder called "__Recipe.Solution__". 
...
Create a new file in the root directory of the __Recipe.Solution/Recipe__ directory named "appsettings.json".  Copy and past the following code inside of the file.
